...
- **`docs/adr/`** — eight decisions that are hard to reverse. Read 0001 and 0003 before changing authorization or user provisioning, 0004 before touching charge of a Peregrina, 0005 before touching territory or Modalidad, 0006 before changing how the UI is tested, 0007 before touching a filter, a figure or an index, and 0008 before touching pagination or a form's validation timing.
